...
predictor = dlib.shape_predictor(
    "C:\\Users\\Bruno\Desktop\\[RESEARCH] Graduation Project\\.[PROGRAM] Final Version\\Graduation-Project-main\\shape_predictor_68_face_landmarks.dat")
...
def diff_c(dlib46, stepSize):
    ...
    for i in range(n_para):
        ...
        jacobian[:, i] = (fun(dlib46, None, candide3.mean3D, candide3.blendshapes, candide3.parameters[:n_para] + step)
                          - fun(dlib46, None, candide3.mean3D, candide3.blendshapes,
                                candide3.parameters[:n_para] - step)) / (2 * stepSize)
    # end_diffc = time.time()
    # print("diffc")
