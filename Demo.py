...
if __name__ == "__main__":
    #cap = cv2.VideoCapture('Britney.mp4')
    cap = cv2.VideoCapture(0)

    os.chdir('C:\\Users\\Bruno\\Desktop\\[RESEARCH] Graduation Project\\.[PROGRAM] Final Version\\Graduation-Project-main\\Bruno\\newModel\\Bruno_demo\\Skull Model')
    file_list = os.listdir(r"C:\\Users\\Bruno\\Desktop\\[RESEARCH] Graduation Project\\.[PROGRAM] Final Version\\Graduation-Project-main\\Bruno\\newModel\\Bruno_demo\\Skull Model")
    # SCREEN SETTINGS
    pygame.init()
    display = (500, 500)
